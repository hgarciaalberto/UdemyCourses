...
val accountList = listOf(
    Account(icon = R.drawable.tutorial_icon, userName = "Tutorials EU", email = "tutorials@eu.com", unReadMails = 99),
    Account(userName = "Chris Morty", email = "chris@eu.com", unReadMails = 80),
    Account(userName = "Christy Jane", email = "jane@eu.com", unReadMails = 65)
)